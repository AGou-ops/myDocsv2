  ...
  themeConfig: {
    ...
    sidebar: {
                ...
                "/k8s/": [{
                    ...
                    collapsable: true,
                    children: [
                        ["/k8s/Quicklystart/一 Kubernetes概述","一 Kubernetes概述"],
                        ["/k8s/Quicklystart/二 核心组件及附件","二 核心组件及附件"],
                        ["/k8s/Quicklystart/三 集群部署","三 集群部署"],
                        ["/k8s/Quicklystart/四 入门命令","四 入门命令"],
                        ["/k8s/Quicklystart/五 配置清单使用","五 配置清单使用"],
                        ["/k8s/Quicklystart/六 POD 配置清单","六 POD 配置清单"],
                        ["/k8s/Quicklystart/七 控制器配置清单","七 控制器配置清单"],
                        ["/k8s/Quicklystart/八 Service 配置清单","八 Service 配置清单"],
                        ["/k8s/Quicklystart/九 ingress 控制器","九 ingress 控制器"],
                        ["/k8s/Quicklystart/十 POD 存储卷","十 POD 存储卷"],
                        ["/k8s/Quicklystart/十一 配置信息容器化","十一 配置信息容器化"],
                        ["/k8s/Quicklystart/十二 StatefulSet 控制器","十二 StatefulSet 控制器"],
                        ["/k8s/Quicklystart/十三 用户认证系统","十三 用户认证系统"],
                        ["/k8s/Quicklystart/十四 用户权限系统","十四 用户权限系统"],
                        ["/k8s/Quicklystart/十五 dashboard","十五 dashboard"],
                        ["/k8s/Quicklystart/十六 网络通信","十六 网络通信"],
                        ["/k8s/Quicklystart/十七 调度策略","十七 调度策略"],
                        ["/k8s/Quicklystart/十八 高级调度设置","十八 高级调度设置"],
                        ["/k8s/Quicklystart/十九 容器资源限制","十九 容器资源限制"],
                    ]
                }, 
                {
                    title: "Helm",
                    ...
                    collapsable: true,
                    children: [
                        ["/k8s/Helm/Helm Basic", "Helm Basic"],
                        ["/k8s/Helm/charts", "Helm charts"],
                        ["/k8s/Helm/Helm（Go）template", "Helm（Go）template"],
                    ]
                },
                {
                    title: "Others",
    ...
    return [{
        ...
        },
        {
            ...
            children: [
                ...
                ["/post/ELK/ES Docker三节点部署", "ES Docker三节点部署"],
                ["/post/ELK/ES 配置文件详解", "ES 配置文件详解"],                
